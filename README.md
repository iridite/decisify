...
- **Python 实现** (`brain.py`): 快速原型、实时单次决策
...
### 3. Brain (`brain.py` / `brain_hybrid.py`)
...
python benchmark.py              # Single decision benchmark
python benchmark_realistic.py    # End-to-end benchmark
python benchmark_batch.py        # Batch processing benchmark
